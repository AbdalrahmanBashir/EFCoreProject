...
public partial class PharmacyPrescriptionManagementSystemContext : DbContext
{
    public PharmacyPrescriptionManagementSystemContext()
    {
    }

    public PharmacyPrescriptionManagementSystemContext(DbContextOptions<PharmacyPrescriptionManagementSystemContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseNpgsql("Host=localhost;Database=PharmacyPrescriptionManagementSystem;Username=postgres;Password=root");
